...
function PastTicketCard({ ticket }: IDateProps) {
    return (
      <main className="flex flex-col md:flex-row items-center space-y-[3vh] md:space-x-[3vw] justify-evenly pb-[6vh] ">
        {ticket.available ? (
          <>
          ...
          <article className="flex flex-col-reverse">
            ...
            <section className="space-y-[3vh] w-[60vw] md:w-[30vw] text-center md:text-center">
            ...
            <section className="text-center md:text-left w-[80vw] md:w-[40vw]">
              <h1
                className={`${bebas.variable} font-sans text-left text-3xl md:text-6xl space-x-8 text-red-800 uppercase`}
              >
                {ticket.name}
              </h1>
              <h1
                className={`${bebas.variable} font-sans text-xl md:text-5xl space-x-8 uppercase`}
              >
                {ticket.date}
              </h1>
            </section>
