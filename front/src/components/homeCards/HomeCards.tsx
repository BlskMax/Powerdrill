...
<>
    <main className="md:flex md:flex-row md:ml-auto md:mr-[2vw] md:w-[90vw]
     ">
        ...
        ">
            <button type="button" onClick={() => router.push('/sound')} className="cursor-pointer hover:scale-105 duration-500">
                <img 
                    src="/images/musicaMock.png" 
                    className="md:w-[70vw] md:h-full md:mt-0 md:mb-0  md:rounded-none
            ...
            <div className="md:flex md:flex-row">
                <button type="button" onClick={() => router.push('/tickets')} className="cursor-pointer hover:scale-105 duration-500">
                    <img 
                ...
                <button type="button" onClick={() => router.push('/store')} className="cursor-pointer hover:scale-105 duration-500">
                    <img 
        ...
        <button type="button" onClick={scrollToSection} className="cursor-pointer hover:scale-105 duration-500 ml-auto">
            <img 
